...
public interface Salary_Service {
	...
	//获取所有老师指定时间段的工资明细
	public ArrayList<Teacher_salary> getAllSalaries(String teacher_id,String startTime,String endTime);
	
	public boolean setSalary(String teacher_id,String salary_time);//设定老师指定时间的工资
	
	//TODO 要不要写成触发器
	public int calBonus(String teacher_id,String salary_time);//计算老师指定时间的奖金
