...
<!--sidebar-menu-->
	<div id="sidebar">
		...
		<ul>
			...
			<li class="active"><a href="all-salary"><i class="icon icon-signal"></i><span>查看薪资报表</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="tables" class="current">查看薪资报表</a> </div>
    <h1>查看薪资报表</h1>
  </div>
