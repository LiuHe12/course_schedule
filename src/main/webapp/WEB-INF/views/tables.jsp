...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="tables"><i class="icon icon-th"></i> <span>Tables</span></a></li>
    <li><a href="calendar"><i class="icon icon-file"></i> <span>Calendar</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="tables" class="current">Tables</a> </div>
    <h1>Tables</h1>
  </div>
